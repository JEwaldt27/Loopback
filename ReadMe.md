...
- ✅ Legend node — click "Legend" to add a draggable canvas node listing the cable types actually used in the current diagram (color swatch + name, plus part number / cable color when set)
